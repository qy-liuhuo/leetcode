...
//</ul>
//
//<div><div>Related Topics</div><div><li>双指针</li><li>字符串</li></div></div><br><div><li>👍 788</li><li>👎 0</li></div>

//leetcode submit region begin(Prohibit modification and deletion)
class Solution {
    public boolean isPalindrome(String s) {
        List<Character> res = s.chars()
                .map(a ->{if (a >= 'A' && a <= 'Z') return a + 32; return a;})
                .filter(a -> {return (a >= 'a' && a <= 'z') || (a >= '0' && a <= '9');})
                .mapToObj(a -> (char)a)
