...
//</ul>
//
//<div><div>Related Topics</div><div><li>数组</li><li>排序</li><li>堆（优先队列）</li></div></div><br><div><li>👍 249</li><li>👎 0</li></div>
...
class Solution {
    public String[] findRelativeRanks(int[] score) {
        ...
        Arrays.sort(ranks, (int[] a, int[] b)->{
            return  b[0] - a[0];
        });
        for(int i = 0; i < len; i++){
            res[ranks[i][1]] = i < 3 ? medals[i] :  Integer.toString(i + 1);
        }
        return res;
    }
}
